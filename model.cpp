...
std::vector<glm::vec3> Model::makeWireStarts()
{
    ...
    glm::vec3 point5 = glm::vec3(ROBOT_FRAME_SIZE+LATERAL_WIRE_OFFSET,ROBOT_FRAME_SIZE+VERTICLE_WIRE_OFFSET,ROBOT_FRAME_SIZE+LATERAL_WIRE_OFFSET);
    glm::vec3 point6 = glm::vec3(ROBOT_FRAME_SIZE+LATERAL_WIRE_OFFSET,ROBOT_FRAME_SIZE-VERTICLE_WIRE_OFFSET+ROBOT_HEIGHT,ROBOT_FRAME_SIZE+LATERAL_WIRE_OFFSET);
    glm::vec3 point7 = glm::vec3(ROBOT_LENGTH-LATERAL_WIRE_OFFSET,ROBOT_FRAME_SIZE-VERTICLE_WIRE_OFFSET+ROBOT_HEIGHT,ROBOT_FRAME_SIZE+LATERAL_WIRE_OFFSET);
    glm::vec3 point8 = glm::vec3(ROBOT_LENGTH-LATERAL_WIRE_OFFSET,ROBOT_FRAME_SIZE+VERTICLE_WIRE_OFFSET,ROBOT_FRAME_SIZE+LATERAL_WIRE_OFFSET);

    glm::vec3 point1 = glm::vec3(ROBOT_FRAME_SIZE+LATERAL_WIRE_OFFSET,ROBOT_FRAME_SIZE+VERTICLE_WIRE_OFFSET,ROBOT_FRAME_SIZE-LATERAL_WIRE_OFFSET+ROBOT_LENGTH);
    glm::vec3 point2 = glm::vec3(ROBOT_FRAME_SIZE+LATERAL_WIRE_OFFSET,ROBOT_FRAME_SIZE-VERTICLE_WIRE_OFFSET+ROBOT_HEIGHT,ROBOT_FRAME_SIZE-LATERAL_WIRE_OFFSET+ROBOT_LENGTH);
    glm::vec3 point3 = glm::vec3(ROBOT_LENGTH-LATERAL_WIRE_OFFSET,ROBOT_FRAME_SIZE-VERTICLE_WIRE_OFFSET+ROBOT_HEIGHT,ROBOT_FRAME_SIZE-LATERAL_WIRE_OFFSET+ROBOT_LENGTH);
    glm::vec3 point4 = glm::vec3(ROBOT_LENGTH-LATERAL_WIRE_OFFSET,ROBOT_FRAME_SIZE+VERTICLE_WIRE_OFFSET,ROBOT_FRAME_SIZE-LATERAL_WIRE_OFFSET+ROBOT_LENGTH);
...
std::vector<frame> Model::makeFrame()
{
    ...
    frame frame3(glm::vec3(0.0,0.0,ROBOT_LENGTH),glm::vec3(ROBOT_LENGTH,ROBOT_FRAME_SIZE,ROBOT_LENGTH+ROBOT_FRAME_SIZE));
    frame frame4(glm::vec3(0.0,0.0,0.0),glm::vec3(ROBOT_FRAME_SIZE,ROBOT_FRAME_SIZE,ROBOT_LENGTH));
    ...
    frame frame11(glm::vec3(0.0,ROBOT_FRAME_SIZE+ROBOT_HEIGHT,ROBOT_LENGTH),glm::vec3(ROBOT_LENGTH,ROBOT_FRAME_SIZE+ROBOT_FRAME_SIZE+ROBOT_HEIGHT,ROBOT_LENGTH+ROBOT_FRAME_SIZE));
    frame frame12(glm::vec3(0.0,ROBOT_FRAME_SIZE+ROBOT_HEIGHT,0.0),glm::vec3(ROBOT_FRAME_SIZE,ROBOT_FRAME_SIZE+ROBOT_FRAME_SIZE+ROBOT_HEIGHT,ROBOT_LENGTH));
